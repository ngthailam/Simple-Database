...
BNODE_LEAF_VALUE_MAX_BYTES = 500
BNODE_LEAF_ENTRY_FORMAT = f'<i{BNODE_LEAF_VALUE_MAX_BYTES}s' # key (4 bytes), value (BNODE_LEAF_VALUE_MAX_BYTES bytes)
BNODE_LEAF_ENTRY_SIZE = struct.calcsize(BNODE_LEAF_ENTRY_FORMAT)
LEAF_MAX_KEYS = (PAGE_SIZE - BNODE_LEAF_HEADER_OFFSET) // BNODE_LEAF_ENTRY_SIZE
